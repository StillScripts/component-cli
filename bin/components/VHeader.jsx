...
function VHeader({ subtitle = "" }) {
    return (<section className="py-20" id="header">
     ...
     Get Started/> ➔
          ...
          <div className="col lg:w-6/12 mt-12 lg:mt-0">
            <img className="block mx-auto lg:mr-0 pr-6 lg:max-w-[500px]" src="https://d1pnnwteuly8z3.cloudfront.net/images/dafc1e05-b0e8-4c6d-b375-4a62333bbd5a/db204aff-2783-412a-9f3d-8ff54d267d9f.png" 
